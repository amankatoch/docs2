...
(function($, window) {
    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        resizing: function(resize) {
            this.ec("enableObjectResizing", false, resize);
        },
        unlink: function() {
        ...
        readOnly: function(readOnly) {
            this.ec('readOnly', false, readOnly);
            this.ec('contentReadOnly', false, readOnly);
        },
        fontName: function(fontName) {
            this.ec("fontName", false, fontName);
        },
        fontSize: function(fontSize) {
            this.ec("fontSize", false, fontSize);
        },
        ...
        backgroundColor: function(c) {
            this.ec("backColor", false, c !== undefined ? c : prompt("Enter HTML Color:", "#"));
        },
